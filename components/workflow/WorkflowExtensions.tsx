...
const Result = ({ state }: { state: WorkflowState }) => <>{state.error && <p className="workflow-error" role="alert">{state.error}</p>}{state.success && <p className="workflow-success" role="status">{state.success}</p>}</>;
