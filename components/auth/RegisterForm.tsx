...
export default function RegisterForm(){
 ...
 <label htmlFor="register-id">รหัสนักศึกษา *</label><input id="register-id" name="student_id" {...numericInputProps()} pattern="[0-9]{8,12}" minLength={8} maxLength={12} required/>
