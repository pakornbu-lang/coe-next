...
แดชบอร์ดนักศึกษาแสดงรายการข้อมูลโปรไฟล์ที่ยังขาดสำหรับกรอกใบสมัครทุน และลิงก์เปิดฟอร์มโปรไฟล์โดยตรง เมื่อกรอกครบการเตือนจะหายไป นักศึกษายังดูทุนและบันทึกร่างได้ ข้อมูลที่ใช้ร่วมกันถูกเติมในใบสมัครเบื้องต้นและแก้ไขได้ก่อนส่ง ส่วนรายได้ เหตุผลสมัคร บัญชีรับเงิน และเอกสารยังกรอกแยกตามทุน
