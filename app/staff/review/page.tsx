...
export default async function StaffReviewListPage({ searchParams }: { searchParams: Promise<{ status?: string; q?: string; application?: string }> }) {
  await requireRole(["staff"]);
  const { status = "", q = "", application } = await searchParams;
