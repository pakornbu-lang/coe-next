...
export default async function Page() {
  const [{ scholarships, total, counts }, viewer] = await Promise.all([listLandingScholarships(), getViewer()]);
  const contact = {
  ...
  return <Landing scholarships={scholarships} totalScholarships={total} scholarshipCounts={counts} viewer={viewer} contact={contact} />;
}
