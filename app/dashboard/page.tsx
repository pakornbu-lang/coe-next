    ...
    <div className="workflow-stack">
      <section className="panel workflow-heading">
        <div>
          ...
          <h1>สวัสดี {viewer.fullName}</h1>

          <p>
            ติดตามทุนที่สนใจและสถานะใบสมัครของคุณได้จากหน้านี้
          </p>
        </div>
      </section>
      ...
      {missing.length > 0 && (
        <section
          className="panel workflow-profile-prompt"
        ...
        >
          <div>
            ...
            <h2 id="profile-prompt-title">
              เติมโปรไฟล์เพื่อสมัครทุนได้เร็วขึ้น
            </h2>

            <p>
              ข้อมูลที่กรอกไว้จะถูกเติมในใบสมัครทุนเบื้องต้น
              คุณยังแก้ไขและตรวจทานได้ก่อนส่ง
            </p>

            <p className="workflow-profile-missing">
              <strong>
                ยังขาด {missing.length} รายการ:
              </strong>{" "}
              {missing.join(" · ")}
            </p>
          </div>
          ...
          <Link
            className="btn"
            href="/profile?edit=1#profile-editor"
          >
            จัดการโปรไฟล์
          </Link>
        </section>
      ...
      <section className="panel">
        ...
        {applications.length ? (
          <div className="workflow-row-list">
            {applications
              .slice(0, 5)
              .map((item) => (
                <Link
